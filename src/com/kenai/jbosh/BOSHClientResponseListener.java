...
/**
 * Interface used by parties interested in monitoring inbound responses to the
 * client from the connection manager (CM). No opportunity is provided to
 * manipulate the response.
 * <p/>
 * Listeners are executed by the message processing thread and should not block
