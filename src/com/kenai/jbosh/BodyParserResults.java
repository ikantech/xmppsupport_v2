...
final class BodyParserResults {
	...
	/**
	 * Map of qualified names to their values. This map is defined to match the
	 * requirement of the {@code Body} class to prevent excessive copying.
	 */
	 ...
	 *            attribute value
	 */
	void addBodyAttributeValue(final BodyQName name, final String value) {
