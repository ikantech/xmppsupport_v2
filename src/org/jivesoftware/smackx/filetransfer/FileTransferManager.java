...
public class FileTransferManager {
	 ...
	 * 
	 * @param userID
	 *            The fully qualified jabber ID (i.e. full JID) with resource of
	...
	public OutgoingFileTransfer createOutgoingFileTransfer(String userID) {
		...
		// We need to create outgoing file transfers with a full JID since this
		// method will later
		// use XEP-0095 to negotiate the stream. This is done with IQ stanzas
		// that need to be addressed to a full JID
