...
/**
 * This class provides an abstract view to gateways/transports. This class
 * handles all actions regarding gateways and transports.
 * 
 * @author Till Klocke
 * 
 */
public class Gateway {
	...
	/**
	 * Returns the name as proposed in this gateways identity discovered via
	 * service discovery
	 * 
	...
	/**
	 * Returns the type as proposed in this gateways identity discovered via
	 * service discovery. See {@link http
	 * ://xmpp.org/registrar/disco-categories.html} for possible types
	 * 
	...
	/**
	 * Returns true if the registration informations indicates that you are
	 * already registered with this gateway
	 * 
	...
	/**
	 * Returns the value of specific field of the registration information. Can
	 * be used to retrieve for example to retrieve username/password used on an
	...
	/**
	 * With this method you can register with this gateway or modify an existing
	 * registration
	 * 
	 * @param username
	 *            String describing the username
	 * @param password
	 *            String describing the password
	 * @param fields
	 *            additional fields like email.
	 * @throws XMPPException
	 */
	public void register(String username, String password,
			Map<String, String> fields) throws XMPPException {
		if (getRegisterInfo().isRegistered()) {
			throw new IllegalStateException(
					"You are already registered with this gateway");
		}
		...
		if (result != null && result instanceof IQ) {
			...
			roster.createEntry(entityJID, getIdentity().getName(),
					new String[] {});
		} else {
	...
	/**
	 * A convenience method for registering or modifying an account on this
	 * gateway without additional fields
	 * 
	 * @param username
	 *            String describing the username
	 * @param password
	...
	/**
	 * Lets you login manually in this gateway. Normally a gateway logins you
	 * when it receives the first presence broadcasted by your server. But it is
	 * possible to manually login and logout by sending a directed presence.
	 * This method sends an empty available presence direct to the gateway.
	 */
	public void login() {
