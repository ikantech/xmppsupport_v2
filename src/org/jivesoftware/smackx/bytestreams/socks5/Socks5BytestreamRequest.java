...
public class Socks5BytestreamRequest implements BytestreamRequest {
	...
	public Socks5BytestreamSession accept() throws XMPPException,
		...
		Collection<StreamHost> streamHosts = this.bytestreamRequest
				.getStreamHosts();
		...
		String digest = Socks5Utils.createDigest(this.bytestreamRequest
				.getSessionID(), this.bytestreamRequest.getFrom(), this.manager
		...
		return new Socks5BytestreamSession(socket, selectedHost.getJID()
				.equals(this.bytestreamRequest.getFrom()));
	...
	private Bytestream createUsedHostResponse(StreamHost selectedHost) {
		Bytestream response = new Bytestream(
