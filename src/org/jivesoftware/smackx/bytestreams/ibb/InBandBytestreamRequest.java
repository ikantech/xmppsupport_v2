...
public class InBandBytestreamRequest implements BytestreamRequest {
	...
	public InBandBytestreamSession accept() throws XMPPException {
		...
		InBandBytestreamSession ibbSession = new InBandBytestreamSession(
				connection, this.byteStreamRequest,
				this.byteStreamRequest.getFrom());
		this.manager.getSessions().put(this.byteStreamRequest.getSessionID(),
				ibbSession);
