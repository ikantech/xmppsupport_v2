...
public class InBandBytestreamManager implements BytestreamManager {
	...
	private InBandBytestreamManager(Connection connection) {
		...
		this.connection.addPacketListener(this.dataListener,
				this.dataListener.getFilter());

		// register bytestream close packet listener
		this.closeListener = new CloseListener(this);
		this.connection.addPacketListener(this.closeListener,
				this.closeListener.getFilter());
