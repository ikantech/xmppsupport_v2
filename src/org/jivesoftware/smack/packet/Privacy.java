...
public class Privacy extends IQ {
	...
	public void deletePrivacyList(String listName) {
		...
		if (this.getDefaultName() != null
				&& listName.equals(this.getDefaultName())) {
	...
	public String getChildElementXML() {
		...
		if (this.isDeclineActiveList()) {
			...
			if (this.getActiveName() != null) {
				buf.append("<active name=\"").append(this.getActiveName())
						.append("\"/>");
			}
		}
		// Add the default tag
		if (this.isDeclineDefaultList()) {
			...
			if (this.getDefaultName() != null) {
				buf.append("<default name=\"").append(this.getDefaultName())
						.append("\"/>");
			}
		}

		// Add the list with their privacy items
		for (Map.Entry<String, List<PrivacyItem>> entry : this.getItemLists()
				.entrySet()) {
