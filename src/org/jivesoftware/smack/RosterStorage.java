...
/**
 * This is an interface for persistent roster storage needed to implement
 * XEP-0237
 * 
 * @author Till Klocke
 * 
...
public interface RosterStorage {
	...
	/**
	 * This method returns a List object with all RosterEntries contained in
	 * this store.
	 * 
	...
	/**
	 * This methos returns the version number as specified by the "ver"
	 * attribute of the local store. Should return an emtpy string if store is
	 * empty.
	 * 
	...
	/**
	 * This method stores a new RosterEntry in this store or overrides an
	 * existing one. If ver is null an IllegalArgumentException should be
	 * thrown.
	 * 
	 * @param entry
	 *            the entry to save
	 * @param ver
	 *            the version this roster push contained
	 */
